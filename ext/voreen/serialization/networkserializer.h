...
public:
    ...
    */
    void writeNetworkToFile(const inviwo::ProcessorNetwork* network, const std::string& filename)
     ...
     */
    inviwo::ProcessorNetwork* readNetworkFromFile(std::string filename)
        throw (SerializationException);
