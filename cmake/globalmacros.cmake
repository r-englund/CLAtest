        ...
        if(BUILD_${mod_name})
            if(EXISTS "${IVW_MODULE_DIR}/${dir}/depends.cmake")
                ...
                foreach(depend_folder ${depend_folders})
                    ...
                    if(NOT BUILD_${depend_mod_name})
                        set(BUILD_${depend_mod_name} ON CACHE BOOL "Build ${depend_name_cap} Modules" FORCE)
                        message("${depend_mod_name} was set to build, due to dependency towards ${mod_name}")
                    endif()
                endforeach()
            endif()
        endif()
...
macro(generate_unset_mod_options_and_depend_sort retval)
    ...
    foreach(dir ${sub-dir})
        if(IS_DIRECTORY ${IVW_MODULE_DIR}/${dir})
            ...
            ivw_dir_to_mod_prefix(mod_name ${dir})
            if(NOT DEFINED BUILD_${mod_name})
