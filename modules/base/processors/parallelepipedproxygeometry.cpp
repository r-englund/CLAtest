...
namespace inviwo {
	...
	ProcessorClassName(ParallelepipedProxyGeometry, "ParallelepipedProxyGeometry"); 
	ProcessorCategory(ParallelepipedProxyGeometry, "Geometry Creation");
	ProcessorCodeState(ParallelepipedProxyGeometry, CODE_STATE_EXPERIMENTAL); 

	ParallelepipedProxyGeometry::ParallelepipedProxyGeometry()
		: ProcessorGL(),
	...
	void ParallelepipedProxyGeometry::initialize() {
		ProcessorGL::initialize();
	}

	void ParallelepipedProxyGeometry::deinitialize() {
