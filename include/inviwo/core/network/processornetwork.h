 ...
 * Processors, which Ports are connected through PortConnections, and which Properties are
 * linked through ProcessorLinks. To manage Processors, PortConnections and ProcessorLinks,
 * add and remove methods are available for all these entities. The network should be only
 * modified by using these methods. Typically these methods are called by the NetworkEditor,
 * which enables the user to edit ProcessorNetworks.
 *
