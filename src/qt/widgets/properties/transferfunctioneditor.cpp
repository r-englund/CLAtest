...
namespace inviwo {
    ...
    const float TransferFunctionEditor::getZoomRangeXMin(){return zoomRangeXMin_;}
    void TransferFunctionEditor::setZoomRangeXMin(float min){zoomRangeXMin_ = min;}
    const float TransferFunctionEditor::getZoomRangeXMax(){return zoomRangeXMax_;}
    void TransferFunctionEditor::setZoomRangeXMax(float max){zoomRangeXMax_ = max;}

    const float TransferFunctionEditor::getZoomRangeYMin(){return zoomRangeYMin_;}
    void TransferFunctionEditor::setZoomRangeYMin(float min){zoomRangeYMin_ = min;}
    const float TransferFunctionEditor::getZoomRangeYMax(){return zoomRangeYMax_;}
